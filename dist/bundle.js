...
(0, _reactDom.render)(_react2.default.createElement(_parent2.default, null), document.getElementById('app'));
...
var Parent = function (_React$Component) {
    ...
    _createClass(Parent, [{
        key: 'handelChange',
        value: function handelChange(event, name) {
            this.setState({
        ...
        value: function render() {
            ...
            Inputs = this.state.name.map(function (value, index) {
                return _react2.default.createElement(_child2.default, { key: index, onChange: this.handelChange.bind(this, 'value' + (index + 1)), name: this.state.name[index], value: this.state.value[index] });
            }.bind(this));
...
var Childs = function (_React$Component) {
    _inherits(Childs, _React$Component);

    function Childs(props) {
        _classCallCheck(this, Childs);

        var _this = _possibleConstructorReturn(this, (Childs.__proto__ || Object.getPrototypeOf(Childs)).call(this, props));
    ...
    _createClass(Childs, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                null,
                this.props.name,
                _react2.default.createElement("input", { type: "radio", checked: this.state.value == 'true', value: "true", onChange: this.handleChange }),
                "\"true\"",
                _react2.default.createElement("input", { type: "radio", checked: this.state.value == 'false', value: "false", onChange: this.handleChange }),
                "\"false\""
            );
        }
    }]);
